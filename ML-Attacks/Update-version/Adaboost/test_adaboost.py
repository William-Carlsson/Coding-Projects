...
# === Load Test Data ===
X_test = pd.read_csv("Adaboost_X_test.csv")
y_test = pd.read_csv("Adaboost_y_test.csv").squeeze()
...
plt.tight_layout()
plt.savefig("adaboost_multiclass_confusion_matrix.png")
plt.show()
...
plt.tight_layout()
plt.savefig("adaboost_roc_multiclass_selected.png")
plt.show()

# === Save Evaluation Metrics to TXT ===
with open("adaboost_evaluation_metrics.txt", "w") as f:
    f.write("AdaBoost Multi-Class Evaluation Metrics:\n")
