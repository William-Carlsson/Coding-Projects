...
# Load test data and TCN model
X_test = np.load("X_test.npy")
print("X_test size:", X_test.shape)
y_test = np.load("y_test.npy")

model = load_model("tcn_ota_model.keras", custom_objects={"TCN": TCN}, compile=False)
...
print("\nTest Evaluation Metrics (TCN Model):")
...
plt.tight_layout()
plt.savefig("roc_curve_tcn.png")
plt.show()


# === Save Metrics to TXT ===
with open("tcn_evaluation_metrics.txt", "w") as f:
    f.write("TCN Update Detection Evaluation Metrics:\n")
